    ...
    <body style="background-image:url('./images/inbg.jpg');">
        <form id="signup" action="signupconfirm.php" method="post">
            ...
            <div class="container-fluid">    
                <div class="row">
                  <div class="col-sm-12">
                        <a href="index.php><img src="images/cutm.jpg" width="100%" style="box-shadow: 1px 5px 14px #999999; "></img></a>
                  </div>
                 </div>    
             </div>
        <div id="dmid">
        ...
        <div id="ddown">
            ...
            <img src="images/signup1.jpg" style="height:470px;width:550px;border-top-left-radius:15px;border-bottom-left-radius:15px;" ></img>
             ...
             <div id="drig">
                 <br>
            <font style="color:black; margin-left:30px; font-size:22px; font-family: verdana;font-weight: bold;">Sign Up Here (For Parents)</font>
                    <table id="tabintro">
                <tr>
                    <td>
                        <font style="color:black; margin-left:30px; font-family: Verdana;  margin-top:15px; font-size:17px;">Student Name * </font>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <font style="color:black; margin-left:30px; font-family: Verdana;font-size:17px;">Date of Birth (Student) * <font>
                    </td>
                </tr>
                <tr>
                    <td  style="padding-bottom: 1em;">
                 ...
                 <tr>
                    <td>
                       <font style="color:black; margin-left:30px; font-family: Verdana;font-size:17px;" required> Email ID (For Parent) <font>
                    </td>
                 </tr>
                 <tr>
                    <td  style="padding-bottom: 1em;">
                ...
                <tr>
                    <td>
                       <font style="color:black; margin-left:30px; font-family: Verdana;font-size:17px;" required> Mobile No. (For Parent) *<font>
                    </td>
                 </tr>
                 <tr>
                    <td  style="padding-bottom: 1em;">
                ...
                <tr>
                    <td  style="padding-bottom: 1em;">
                        ...
                        <input type='text' id='txt_captcha' name='txt_captcha' placeholder="Enter the code from the image above" required="true"> 
                    </td>
