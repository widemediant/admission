...
<html>
    <head>
       ...
       <script src="bootstrap/jquery.min.js"></script>
        ...
        <title>Welcome to Kwa Kalusya Online Admission</title>
        ...
        <form id="index" action="index.php" method="post">
            ...
            <div class="container-fluid">    
                ...
                <div  id="divtop">
                        ...
                        <br> <br> <br> <br>
                            <div id="dmain"  > 
                               <center><img src="./images/loginuser.png" width="180px" height="100px" ></center>
                                <br>
                                    ...
                                    <input type="submit" id="u_sub" name="u_sub" value="Login" class="toggle btn btn-primary"><br>
                                    <center><a href="signup.php">Sign Up </a> | 
                                    <a href="adminlogin.php">Admin </a></center>
                             </div>
                     </div>
                    </div>
                    <div id="footer">
                        <center> <p> ALL RIGHTS RESERVED (C)2025 - DESIGNED BY <a href="https://wa.me/c/254704815094" target="blank">US</a></center>
               </div>
            </div>  
            </div>
        </form>  
