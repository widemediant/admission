...
if($_REQUEST["t_user_data"]!="")
{
    $id = $_REQUEST["t_user_data"];
    $ra = mysqli_query($con, "select ad_name from t_user_data where s_id = '$s_id'");
...
{
    $id = $_REQUEST["t_user"];
    $ra = mysqli_query($con, "select s_omr from t_usermark where s_id = '$s_id'");
    echo mysqli_fetch_array($ra)[0];
    die();
}
...
$q=mysqli_query($con,"select ad_name from t_admin where ad_id='".$getid."'");
...
if(isset($_REQUEST["submitmarks"]))
{
 ...
 function AdminCode()
  {
      $con = mysqli_connect("localhost", "root", "", "oas");
      $rs  = mysqli_query($con,"select CONCAT('AD',LPAD(RIGHT(ifnull(max(ad_id),'AD0'),2) + 1,2,'0')) from t_admin");
            ...
            <div class="container-fluid" id="dmid">    
             ...
             <div class="container">
                    <ul class="nav nav-tabs" >
                        ...
                        <li class="active"><a data-toggle="tab" href="#viewapp">View Students</a></li>
                        <li><a data-toggle="tab" href="#aduser">Admit New Student</a></li>
                        ...
                        <center> <div class="jumbotron" style="width:50%; box-shadow: -3px 3px 10px #999999;   margin-top:10px;">
                             <div class="row">
                                <div class="col-sm-6">  
                                       ...
                                       <input type="text" name="omarkof" id="search1" class="form-control"  placeholder="STUDENT ID" style="width:200px;"/> 
                                 ...
                                 <div class="col-sm-6">     
                                   ...
                                   <input type="text" name="txtomr" placeholder="STUDENT PASSWORD" class="form-control" style="width:200px;"/>
